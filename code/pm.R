...
proj.submenu <- list(
	...
	c("Extraction", "ALFRESCO: Rmpi", "ALFRESCO: functions", "divider", "Organization", "ALFRESCO: final prep"),
	c("Autocorrelation", "Intro/example", "divider", "Working with SNAP data", "ALFRESCO"),
...
proj.files <- list(
	...
	c("header", "alfExtractMain.html", "alfExtract.html", "divider", "header", "alfPrep.html"),
	c("header", "sp_ac_clump.html", "divider", "header", "pres1_snapdata_alfresco.html"),
