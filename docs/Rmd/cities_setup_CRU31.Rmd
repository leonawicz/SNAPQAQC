---
title: CRU 3.1 Cities Setup Code
...
read_chunk("../../code/cities_setup_CRU31.R")
```

## Introduction
This script prepares extracted CRU 3.1 community temperature and precipitation data for direct use.
