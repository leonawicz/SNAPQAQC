...
opts_chunk$set(cache=FALSE, eval=TRUE, tidy=FALSE, message=FALSE, warning=FALSE)
...
Secondary order code relates organization and preparation of useful data products which are taken up my web applications and other projects to investigate the data.
