...
1. Specific data are extracted from a 500,000 high-resolution, spatially explicit geotiffs.
...
- Data describe distributions of random variables (RVs) rather than specific statistics

2. Stored data are organized for easy analysis
...
3. Organized data are loaded in a specific project to be analyzed

## A closer look at data prep

Prep:
Statistical modeling: Probability distributions of random variables
