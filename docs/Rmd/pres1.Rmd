...
opts_chunk$set(cache=FALSE, eval=TRUE, echo=FALSE, tidy=TRUE, results="asis", messages=FALSE, warnings=FALSE, dpi=72, fig.width=5, fig.height=3)
...
Let $X$ be a continuous random variable of interest, e.g., stand age, burn area, precipitation, etc.
...
- No need to return to raw maps each time a new summary is requested; compute it with the distribution model
