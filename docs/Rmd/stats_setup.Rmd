---
title: GCM Statistics Setup Code
...
read_chunk("../../code/stats_setup.R")
```


## Introduction
This script prepares extracted AR4/CMIP3 and AR5/CMIP5 regional temperature and precipitation data for direct use.
