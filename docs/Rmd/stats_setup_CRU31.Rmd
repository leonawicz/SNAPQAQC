---
title: CRU 3.1 Statistics Setup Code
...
read_chunk("../../code/stats_setup_CRU31.R")
```


## Introduction
This script prepares extracted CRU 3.1 regional temperature and precipitation data for direct use.
